...
SYSTEM_PROMPT_BASE = (
    ...
    "decision per cycle.\n\n"
    "A. PRICE BAND (computed as IPP)\n"
    "-------------------------------\n"
    "Each cycle, compute:\n"
    "    IPP = 500_000 * current_price_usd\n\n"
    "Bands:\n"
    "  - IPP < 180         → BUY band.\n"
    ...
    "0.05 (period log-return stdev), drop the Sunday/time gate. Require "
    "only RSI < 30 plus the reversal in B.3.\n\n"
    "C. EXITS\n"
    "--------\n"
    ...
    "  - No sells in the BUY or NEUTRAL bands, even if RSI > 70.\n"
