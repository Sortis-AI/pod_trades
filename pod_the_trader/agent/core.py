...
SYSTEM_PROMPT_BASE = (
    ...
    "  - 1800 ≤ IPP ≤ 3650 → NEUTRAL band (buys require Section B).\n"
    "  - 3650 < IPP < 5000 → HOLD-ONLY band. No buys. No sells.\n"
    "  - IPP ≥ 5000        → TRIM band. Sell 50% on first entry, then hold.\n\n"
